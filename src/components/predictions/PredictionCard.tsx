  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full text-left p-4 sm:p-6 cursor-pointer focus-ring rounded-card"
        aria-expanded={expanded}
        aria-label={`${prediction.partner.short_name} via ${prediction.issuer.short_name}: ${Math.round(prediction.probability_30d * 100)}% likelihood. ${expanded ? "Hide" : "Show"} reasoning.`}
      >
